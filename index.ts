...
function checkPermissions(user: User): void{
    switch (user.role) {
        case UserRole.Admin:
            console.log(`${user.name} (${user.id}) has full access.`);
            break;
        case UserRole.Editor:
            console.log(`${user.name} (${user.id}) can edit content.`);
            break;
        case UserRole.Viewer:
            console.log(`${user.name} (${user.id}) can view content.`);
            break;
        default:
            console.log(`${user.name} (${user.id}) not found.`)
    }
}
